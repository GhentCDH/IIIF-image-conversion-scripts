...
TOOL="vips"
DESCRIPTION="Convert an image to a lossy pyramidal TIFF (JPEG) using vips."
...
run_conversion() {
    ...
    vips tiffsave "$input" "$output" --tile --pyramid --compression jpeg --Q 90 --tile-width 256 --tile-height 256
}
